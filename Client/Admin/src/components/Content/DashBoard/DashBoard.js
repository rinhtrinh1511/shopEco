...
class DashBoard extends Component {
  ...
  render() {
    ...
    let priceTotal = dashboard.income;
    return (
      <div className="content-inner">
        ...
        <section className="dashboard-counts no-padding-bottom">
          <div className="container-fluid">
                  ...
                  <div className="title">
                    ...
                    <div className="progress">
                      <div
                        ...
                        className="progress-bar bg-violet fix-processbar"
                      />
                    </div>
                  </div>
                  ...
                  <div className="title">
                    ...
                    <div className="progress">
                      <div
                        role="progressbar"
                        style={{ width: "100%", height: "4px" }}
                        className="progress-bar bg-green fix-processbar"
                      />
                    </div>
                  </div>
                  <div className="number">
            ...
            <h3 style={{ paddingTop: 20 }}>Báo cáo sản phẩm của danh mục</h3>
