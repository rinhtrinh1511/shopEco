...
class ActionProduct extends Component {
  ...
  async componentDidMount() {
    ...
    if (id) {
      ...
      if (res && res.status === 200) {
        const resProducer = await callApi(
          `category/${res.data.categoryId}/producers`,
          "GET",
          null
        );
  ...
  handleChangeAddNum = (event) => {
    const inputValue = event.target.value;
    this.setState({ addNumberAvailable: inputValue });
  };
  ...
  handleSubmit = async (event) => {
    ...
    const addn = parseInt(addNumberAvailable);
    ...
    if (!id) {
      ...
      let num = numberAvailable + addn;
      console.log(typeof(numberAvailable))
      console.log(typeof(addn))
      const editProduct = {
        isActive,
        nameProduct: newName,
        price,
                  ...
                  <div className="card-body">
                    ...
                    >
                      ...
                      <div className="form-group row">
                        ...
                        <label
                          className="col-sm-1 form-control-label"
                        ...
                        <div className="col-sm-2">
                          <input
                            name="addNumberAvailable"
                            type="number"
                            value={addNumberAvailable}
                            onChange={this.handleChangeAddNum}
                            className="form-control"
                          />
                        </div>
                      </div>
