...
const routes = [
  ...
  },
  {
    ...
    exact: false,
    main: ({ match, history }) => (
      <ActionRolePage match={match} history={history} />
    ),
  },
  {
    path: "/users/add",
  ...
  },
  {
    ...
    exact: false,
    main: ({ match, history }) => (
      <ActionUserPage match={match} history={history} />
    ),
  },
  {
    path: "/discounts/add",
  ...
  },
  {
    ...
    exact: false,
    main: ({ match, history }) => (
      <ActionDiscountPage match={match} history={history} />
    ),
  },
  {
    path: "/products/add",
  ...
  },
  {
    ...
    exact: false,
    main: ({ match, history }) => (
      <ActionProductPage match={match} history={history} />
    ),
  },
  {
    path: "/categories/add",
  ...
  },
  {
    ...
    exact: false,
    main: ({ match, history }) => (
      <ActionCategoryPage match={match} history={history} />
    ),
  },
  {
    path: "/orders/add",
  ...
  },
  {
    ...
    exact: false,
    main: ({ match, history }) => (
      <ActionOrderPage match={match} history={history} />
    ),
  },
  {
    path: "/producers/add",
  ...
  },
  {
    ...
    exact: false,
    main: ({ match, history }) => (
      <ActionProducerPage match={match} history={history} />
    ),
  },
];
