           ...
           <div className="row">
             ...
             <div className="col-md-12">
               <div className="checkout-form-list">
                 ...
                 <input onChange={this.handleChange} placeholder="số nhà, tên đường, ..." type="text" name="address" value={address} />
               </div>
             </div>
             <div className="col-md-12">
               <div className="order-notes">
                 <div className="checkout-form-list">
                   <label>GHI CHÚ</label>
                   <textarea value={note} onChange={this.handleChange} id="checkout-mess" cols="30" rows="10" name="note" placeholder="..."></textarea>
                 </div>
               </div>
             </div>
           </div>
