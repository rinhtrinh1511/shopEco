...
class CheckOut extends Component {
  ...
  submitOrder = async () => {
    MySwal.fire({
      ...
      text: "Bạn muốn thanh toán cho đơn hàng này?",
      icon: "warning",
            ...
            <div className="col-6">
              <div className="container">
                <ul className="progressbar">
                  ...
                  {result ? (
                    <li className="active">HOÀN THÀNH</li>
                  ) : (
                    <li>HOÀN THÀNH</li>
                  )}
                </ul>
            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="error-wrapper text-center ptb-50 pt-xs-20">
                  ...
                  <div>
                    <h1>Đơn đặt hàng của bạn đã được hoàn tất thành công.</h1>
                  </div>
                  <div>
                    <p>
                      <i>
                        Vui lòng check lịch sử mua hàng trong phần thông tin
                      </i>
                    </p>
                  </div>
                </div>
