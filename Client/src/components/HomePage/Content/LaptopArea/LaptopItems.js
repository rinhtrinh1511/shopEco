...
class LaptopItems extends Component {
  ...
  upItem = (quantity) => {
    if (quantity >= 5) {
      toast.error("Bạn mua được 5 sản phẩm");
      return;
    }
    this.setState({
      quantity: quantity + 1,
  ...
  render() {
    ...
    const { quantity, redirectToDetail } = this.state;
    let sumRating = 0;
    let count = 0;
          ...
          <div className="product_desc">
            <div className="product_desc_info">
              ...
              <div className="price-box">
                ...
                {/* <span className="old-price">{formatNumber.format(product.price * 7 / 100)}</span>
            ...
            <div className="add-actions">
              <ul className="add-actions-link">
                <li className="add-cart active">
                  <div onClick={() => this.addItemToCart(product)}>
                    Thêm vào giỏ
                  </div>
                </li>
                <li>
                        ...
                        <div className="product-additional-info pt-25">
                          <li>
                            <div
                              ...
                              className="links-details"
                            >
                              <i className="fa fa-heart-o" /> Thêm vào danh sách
                              yêu thích
                            </div>
                          </li>
...
export default connect(mapStateToProps, mapDispatchToProps)(LaptopItems);
