                ...
                <div className="product-select-box">
                  <div className="product-short">
                    ...
                    <select className="nice-select" onChange={this.handleChangeSelectSort} >
                      ...
                      <option value="nameProduct">Theo tên (A - Z)</option>
                      <option value="-nameProduct">Theo tên (Z - A)</option>
                      <option value="price">Price (Thấp &gt; Cao)</option>
                      <option value="-price">Price (Cao &gt; Thâp)</option>
                    </select>
                  </div>
                </div>
