...
class ProductViewDetail extends Component {
  ...
  upItem = () => {
    ...
    if (quantity >= 5) {
      return toast.error("Bạn chỉ được mua tối đa 5 sản phẩm cùng một lúc");
    }
    this.setState({
      quantity: ++quantity,
    });
  ...
  downItem = () => {
    let quantity = this.state.quantity;
    if (quantity <= 1) {
      return toast.error("Bạn không thể mua sản phẩm dưới 1");
    }
    this.setState({
      quantity: --quantity,
    });
                        ...
                        <div className="li-review-content">
                          ...
                          <div className="feedback-area">
                            <div className="feedback">
                              <h3 className="feedback-title">Độ yêu thích</h3>
                              <form action="/">
